...
// 그 찾자온 값들 drawerMenuButtonList 상수에 저장
...
// 0 1 2
// forEach를 사용해서 drawerMenuBttonList
// 배열의 각 요소에 대해 반복 해준다.
// fotEach로 반복된 값을 button(매개변수)에 담아준다.
drawerMenuButtonList.forEach(function (button) {
  ...
  // 사용자가 클릭한 버튼의 부모 요소인 drawer-menu의
  // 활성화 상채가 toggle 된다.
